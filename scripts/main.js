...
async function getPlayerSummary(reqsid1) {
  const response = await fetch(`http://207.154.234.205:3000/player_summaries/${reqsid1}`);
...
async function getFriendList(reqsid2) {
  const response = await fetch(`http://207.154.234.205:3000/friend_list/${reqsid2}`);
  const data = await response.json();
  return data;
}

async function getOwnedGames(reqsid3) {
  const response = await fetch(`http://207.154.234.205:3000/owned_games/${reqsid3}`);
  const data = await response.json();
  return data;
}
